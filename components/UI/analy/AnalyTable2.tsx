...
export default function AnalyTable(props: any) {
	...
	// const [tempObj,setTempObj] = useState<{ [key: string]: any }>({});
	let tempObj:{ [key: string]: any } = {};
	let initArr: { [key: string]: string }[];
	const [dataSet,setDataSet] = useState(props?.data); //: { [key: string]: any }
	...
	const isSelectable = (data: any) => {
		...
		// console.log(baseYear,props.yyyy);
		return (baseYear > props.year || baseM > mon || (baseM == mon && baseD > day)) && cell.cellIndex > 0 ? true : false;
	};
	...
	return (
		<div className="card nav">
			<div className="flex justify-end non-print p-[1em]">
